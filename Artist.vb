...
Public Class Artist
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        With Me
            ...
            Try
                strSQL = "Insert into artist (artist_id, artist_name)
                value('" _
                & .TextBox1.Text & "', '" _
                & .TextBox2.Text & "')"
                ...
                MsgBox("Artist Successfully Added")
                Call Clear_Boxes()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim artistID As Integer = Integer.Parse(TextBox1.Text)
        Dim artistName As String = TextBox2.Text
        ...
        If result = DialogResult.Yes Then
            Try
                Call Connect_to_DB()
                Dim query As String = "Delete from artist where artist_id = @artist_id AND artist_name = @artist_name"
                Dim mycmd As New MySqlCommand(query, myconn)
                mycmd.Parameters.AddWithValue("@artist_id", artistID)
                mycmd.Parameters.AddWithValue("@artist_name", artistName)
    ...
    Private Sub Display_Click(sender As Object, e As EventArgs) Handles Display.Click
        ...
        While myreader.Read()
            Me.DataGridView1.Rows.Add(New Object() {myreader.Item("artist_id"), myreader.Item("artist_name")})
        End While
        Call Disconnect_to_DB()
    End Sub
        ...
        If dlg.ShowDialog() = DialogResult.OK Then
            ...
            Using connection As New MySqlConnection(myConnectionString)
                ...
                For Each row As DataRow In dt.Rows
                    Dim insertSql As String = "Insert into artist ("
